...
public class PreferenceUtils {
	...
	private static String PREFERENCE_NAME = "candlestickstatus";
	public static String GREEN_CANDLE_COUNT = "GREEN_CANDLE_COUNT";
	public static String RED_CANDLE_COUNT = "RED_CANDLE_COUNT";
	public static String BORING_CANDLE_COUNT = "BORING_CANDLE_COUNT";
